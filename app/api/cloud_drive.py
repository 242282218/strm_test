...
from app.schemas.cloud_drive import CloudDriveCreate, CloudDriveResponse, CloudDriveUpdate
...
def create_drive(
    drive: CloudDriveCreate, _auth: None = Depends(require_api_key), service: CloudDriveService = Depends(get_service)
):
...
def delete_drive(
    drive_id: int, _auth: None = Depends(require_api_key), service: CloudDriveService = Depends(get_service)
):

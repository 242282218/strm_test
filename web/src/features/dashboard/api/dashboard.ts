 ...
 * @returns 操作结果
 */
export const clearDashboardCache = async (): Promise<DashboardActionResult> => {
  const response = await api.post('/monitor/cache/clear-all')
  return response as unknown as DashboardActionResult
}

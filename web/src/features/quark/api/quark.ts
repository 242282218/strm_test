...
export async function browseQuarkDirectory(
  ...
  const response = await api.get<QuarkBrowseResponse>('/quark/browse', {
    params: {
...
export async function smartRenameCloudFiles(
  ...
  const response = await api.post<QuarkSmartRenameResponse, QuarkSmartRenameRequest>(
    '/quark/smart-rename-cloud',
    params,
    { timeout: 180000 }
  )
  return response.data
...
export async function executeCloudRename(
  ...
  const response = await api.post<QuarkRenameExecuteResponse, QuarkRenameExecuteRequest>(
    '/quark/execute-cloud-rename',
    params,
    { timeout: 120000 }
  )
  return response.data

...
export const scrapeApi = {
  ...
  listRecords(params?: {
    ...
    return api.get('/v1/scrape/records', { params: params || {} })
  },

  getRecord(recordId: string): Promise<ScrapeRecord> {
    return api.get(`/v1/scrape/records/${recordId}`)
  },

  reScrape(recordIds: string[]): Promise<{ requested: number; updated: number; queued_jobs: number }> {
    return api.post('/v1/scrape/re-scrape', { record_ids: recordIds })
  },
